...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new MyHomePage(title: 'Mobize'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Musique> maListeDeMusiques = [
    new Musique('Theme Swift', 'Olivier Charpentier', 'assets/kelsea.jpg', 'https://www.oliviercharpentier.fr/songs/2019/Kelsea_Ballerini/Kelsea_Ballerini-Better_Luck_Next_Time/90-Kelsea%20Ballerini-Better%20Luck%20Next%20Time.flac'),
    new Musique('Theme Flutter', 'Olivier Charpentier', 'assets/hollidays.jpg', 'https://www.oliviercharpentier.fr/songs/2019/Fatbabs/Fatbabs-Holidays/09-Fatbabs_Johaz_John%20Juan_Piff-Another%20Day.flac'),
    //new Musique('Spicy', 'Herve Pagez', 'assets/spicy.jpg', 'https://www.deezer.com/fr/track/686204232'),
  ];
